...
// import { heroData, missionData, whoWeAreData, corePillarsData, valuesData, leadershipQuote } from '../data/About UsData';
...
//         description="Learn About Us BidMetrix.ai, the Indian DSP built for precision performance. We democratize access to premium inventory and enterprise-grade AI."
//         keywords="About Us BidMetrix, DSP company, ad tech India, programmatic advertising platform"
//       />
...
// // Core Pillars Section Component (Premium Animation)
...
//               {/* Card */}
//               <div className="
//                 relative h-full bg-white rounded-2xl p-5 sm:p-6
...
//                 {/* Content */}
//                 <h3 className="relative z-10 text-lg sm:text-xl md:text-2xl font-semibold text-gray-900 mb-2">
//                   {pillar.title}
//                 </h3>
