...
//             Premium inventory across all major digital channels and formats
//           </p>
//         </div>
//       </section>

//       {/* Mobile & In-App Section */}
//       <section id="mobile" className="section-padding bg-white scroll-mt-16">
...
//                   Banner, interstitial, rewarded video, and native ads that feel natural within the app experience.
//                 </p>
//               </Card>
...
//                 </h4>
//                 <p className="text-gray-600">
//                   Reach users based on device type, OS, carrier, and connection type for precise audience segmentation.
//                 </p>
//               </Card>
...
//                 </h4>
//                 <p className="text-gray-600">
//                   Drive high-quality app installs with optimized CPI bidding and deep-link attribution tracking.
//                 </p>
//               </Card>
//             </div>
//           </div>
...
//                 <div className="text-gray-600">Daily Mobile Users</div>
//               </div>
//               <div>
...
//                 <div className="text-gray-600">Mobile Time Spent</div>
//               </div>
//               <div>
//                 <div className="text-4xl font-bold text-indigo-600 mb-2">95%</div>
//                 <div className="text-gray-600">Viewability Rate</div>
//               </div>
//             </div>
//           </div>
//         </div>
...
//       {/* Video & CTV Section */}
//       <section id="video" className="section-padding bg-gradient-to-b from-gray-50 to-white scroll-mt-16">
//         <div className="container-custom">
//           <div className="grid md:grid-cols-2 gap-12 items-center">
...
//       <section id="native" className="section-padding bg-white scroll-mt-16">
//         <div className="container-custom">
//           <div className="grid md:grid-cols-2 gap-12 items-center">
//             <div>
...
//                   In-feed, recommendation widgets, and sponsored content that matches editorial design.
//                 </p>
//                 <ul className="space-y-2 text-sm text-gray-600">
//                   <li>• Content recommendations</li>
//                   <li>• In-feed social ads</li>
...
//                 </h4>
//                 <p className="text-gray-600 mb-4">
//                   Standard IAB sizes for maximum reach and scale across the open web.
//                 </p>
//                 <ul className="space-y-2 text-sm text-gray-600">
...
//                 </h4>
//                 <p className="text-gray-600 mb-4">
//                   Interactive, expandable, and animated ad units for premium brand experiences.
//                 </p>
//                 <ul className="space-y-2 text-sm text-gray-600">
//                   <li>• Expandable banners</li>
//                   <li>• Interactive units</li>
//                   <li>• HTML5 creatives</li>
//                 </ul>
//               </Card>
//             </div>
//           </div>
